...
class File
{
	...
	{
	?>
		<link rel="stylesheet" type="text/css" href="<?php echo $this->style_cdn.'pageclass1-1.2.css'; ?>" charset="utf-8"/>
		<link rel="stylesheet" type="text/css" href="<?php echo $this->style_cdn.'layout-1.2.css'; ?>" charset="utf-8"/>
	...
	function script_header()
	{
		?>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'ui-1.3.js'; ?>" charset="utf-8"></script>
		<?php	
	}
	...
	function script_footer()
	{
	   ...
	   <script type="text/javascript" src="<?php echo $this->script_cdn.'chat-1.1.js'; ?>" charset="utf-8"></script>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'action-1.1.js'; ?>" charset="utf-8"></script> 
			<script type="text/javascript" src="<?php echo $this->script_cdn.'feed-1.2.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'deploy-1.3.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'jquery.form.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'image-1.2.js'; ?>" charset="utf-8"></script>
