...
class File
{
	...
	function script_header()
	{
		?>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'universal_loader-1.1.js'; ?>" charset="utf-8"></script>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'action1-1.1.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'callback-1.2.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'ajax-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'ui-1.1.js'; ?>" charset="utf-8"></script>
		<?php	
	}
