...
class File
{
	...
	{
	?>
		<link rel="stylesheet" type="text/css" href="<?php echo $this->style_cdn.'pageclass1-1.0.css'; ?>" charset="utf-8"/>
		<link rel="stylesheet" type="text/css" href="<?php echo $this->style_cdn.'layout-1.0.css'; ?>" charset="utf-8"/>
	...
	function script_header()
	{
		?>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'universal_loader-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'global-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'notice-1.0.js'; ?>" charset="utf-8"></script> 
			<script type="text/javascript" src="<?php echo $this->script_cdn.'action1-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'callback-1.1.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'ajax-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'ui-1.0.js'; ?>" charset="utf-8"></script>
		<?php	
	}
	...
	function script_footer()
	{
	   ...
	   <script type="text/javascript" src="<?php echo $this->script_cdn.'chat-1.0.js'; ?>" charset="utf-8"></script>
			...
			<script type="text/javascript" src="<?php echo $this->script_cdn.'deploy-1.0.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'jquery.form.js'; ?>" charset="utf-8"></script>
			<script type="text/javascript" src="<?php echo $this->script_cdn.'image-1.0.js'; ?>" charset="utf-8"></script>
