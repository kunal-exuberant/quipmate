...
<div id="upload_box"> 
	<div id="actions">
		...
		<span id="question_link" style="margin-left:1.5em;cursor:pointer;"><img src="http://icon.qmcdn.net/poll_blue.png" height="20" width="20" /><span class="">Question</span></span>		
		<span onclick="ui.mood(this)" style="margin-left:1.5em;cursor:pointer;"><img width="16" height="16" src="http://icon.qmcdn.net/mood_blue.png" /><span class="">Set-Mood</span></span>
		<span id="profile_post_privacy_link" onclick="ui.profile_post_privacy(this,event)" style="margin-left:1.5em;cursor:pointer;"><img title="Set the privacy of your next post" src="http://icon.qmcdn.net/privacy_cc.png" height="20" width="20" /></span>
	</div> 
	<div style="margin-top:.5em;text-align:center;" id="uploader">
