             ...
             else
            {
              // $html = $help->file_get_contents_curl($link);
               ...
               if(@$dom->loadHTMLFile($link))
               {
                  ...
                  $data['host'] = $host = 'https://' . $parse['host'] . '/';
...
?>
						<span id="profile_post_privacy_link" onclick="ui.profile_post_privacy(this,event)" style="margin-left:0.5em;cursor:pointer;"><img title="Set the privacy of your next post" src="<?php

               echo $icon_image;

?>" height="14" width="14" /></span>
   ...
   function bio_fetch()
   {
      ...
      if(isset($_GET['profileid']))
      {
         if(!empty($_GET['profileid']))
         {
            ...
            $privacy['extension'] = $row['extension'];
