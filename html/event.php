...
<div id="wrapper">
	<div id="left">
			...
			<div style="text-align:center;">
				<a style="font-weight:bold;display:block;color:#ffffff;background-color:#555555;padding:0.5em;" href="event.php?id=<?php echo $profileid; ?>" style=""><?php echo $profile_name; ?></a>
			</div>
