...
<div id="wrapper">
	<div id="left">
			...
			<ul style="list-style:none;clear:left;margin-top:3em;" id="links"> 
					<li class="links"><a class="ajax_nav<?php if($page=='news_json') echo ' selected'; ?>" id="news_json" href="?hl=update" title="Updates from your friends"><img class="lfloat" src="http://icon.qmcdn.net/news_rss.png" height="18" width="18" /><span class="name_20">Updates</span></a></li>
