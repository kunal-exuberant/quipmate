...
var ui = (function(){
			...
			function birthday_bomb(me, profileid, date, pageid)
			{
				...
				$('.right_pointer_container').css('left',$('#search_form').position().left+204+'px');			
			...
			{
				$('#uploader').html('<textarea id="question_box" placeholder="Ask your question"/></textarea><input id="question_button" type="submit" value="Ask" onclick="action.group_question_button(this)"><div class="option_container"><input type="text" placeholder="+Add option" value="" class="option_add" onkeydown="action.option_add(this,event)"><div>'); 
				$('#question_box').focus();
			}
			...
			{
				$('#friend_invite').html('<div class="subtitle" >Invite A Friend</div>');
				$('#friend_invite').append('<div><input type="text" style="border:0.1em solid #aaaaaa;width:14em;height:1em;padding:0.5em;margin-right:0.2em;" id="invite_box" value="" placeholder="Enter an email address" /><input type="submit" style="width:4.6em;height:2.4em;padding:0.2em;color:#ffffff;background:#336699;cursor:pointer;" title="Invite A Friend" id="invite_button" value="Invite" onclick="action.friend_invite(this)" /></div>');
			}
			...
			{
				$('#uploader').html('<div id="main_div"><input type="hidden" value="6"/><div></div><div style="margin:0.5em;"><Strong>Select a file on your computer</strong></div><div style="margin-top:15px 0 20 0px;"><div id="photo_preview"></div><form id="pform" method="post" enctype="multipart/form-data" action="/ajax/write.php"><input style="border:1px solid #cccccc;width:30em;height:1.5em;padding:0.5em;margin:0.5em;" type="text" placeholder="Say something about this file" maxlength="200" id="photo_description" name="photo_description"/><input  size="30" type="file" name="photo_box" id="photo_box" /><input style="background-color:#336699;color:#ffffff;height:2.4em;width:5em;cursor:pointer;padding:0.2em;" type="submit" name="upload" id="photo_upload_button" value="Upload"><input type="hidden" id="photo_hidden_profileid" name="photo_hidden_profileid" value="'+profileid+'"/><input type="hidden" name="action" value="'+action+'"/></form></div></div>');
			}
			
			function album_upload(profileid)
			{
				$('#uploader').html('<div id="main_div"><input type="hidden" value="5"/><div></div><div style="margin:0.5em;"><Strong>Add multiple photo from your computer in an album</strong></div><div style="margin-top:15px 0 20 0px;"><div id="moment_preview"></div><form id="mform" method="post" enctype="multipart/form-data" action="/ajax/write.php"><input style="border:1px solid #cccccc;width:30em;height:1.5em;padding:0.5em;margin:0.5em;" type="text" value="Enter album name" maxlength="100" id="moment_name" name="moment_name"/><div  style="display:inline;" id="moment_photo_browser"><input size="40" type="file" class="mom" name="photo_box[]" id="photo_box" /></div><input style="background-color:#336699;color:#ffffff;height:2.4em;width:5em;cursor:pointer;padding:0.2em;" type="submit" name="upload" id="moment_upload_button" value="Upload"><input type="hidden" id="moment_hidden_profileid" name="moment_hidden_profileid" value="'+profileid+'"/><input type="hidden" id="moment_photo_count" name="moment_photo_count" value=""/><input type="hidden" name="action" value="album_upload"/></form></div></div>');
			}
			...
			function menu(me,event)
			{
				...
				else
				{
				 ...
				 $('#account').remove();
				 var pleft = event.pageX-168+'px';
				 var ptop = event.pageY+32+'px';
				 $('body').append('<div id ="account"><div id="menu_pointer"></div><div class="menu_each"><a class="menu_each_a"  href="profile.php?hl=bio">Edit Profile</a></div><div class="menu_each"><a class="menu_each_a"  href="register.php?hl=profile_picture">Change Profile Picture</a></div><div class="menu_each"><a class="menu_each_a" href="settings.php">Account Settings</a></div><div class="menu_each"><a class="menu_each_a" href="logout.php">Logout</a></div></div>'); 
				 $('#account').css('left', pleft);
				 $('#account').css('top', ptop);
			}
			...
			function message()
			{
				...
				$('#message_container').html('<div id="message_title" style="font-weight:bold;color:#ffffff;font-size:1.3em;padding:0.5em 0em;background-color:#336699;text-align:center;">Write a Message</div>');
				...
				$('#message_container').append('<div style="margin: 1em 0em;"><input style="width:6.5em;height:3em;font-weight:bold;background-color:#336699;color:#ffffff;cursor:pointer;" type="submit" value="Cancel" class="message_ok" onclick="ui.message_close(this)" /><input style="margin-left:2em;font-weight:bold;width:6em;height:3em;background-color:#336699;color:#ffffff;cursor:pointer;" type="submit" value="Send" id="mood_done" onclick="action.message(this)"/></div>');
			}
			...
			function tagline(me)
			{
				...
				$('#tagline_container').html('<div id="tagline_title" style="font-weight:bold;color:#ffffff;font-size:1.3em;padding:0.5em 0em;background-color:#336699;text-align:center;">What drives you today?</div>');
				$('#tagline_title').append('<div style="float:right;cursor:pointer;margin-right:0.5em;" onClick ="ui.tagline_close()">x</div>');
				$('#tagline_container').append('<div style="height:9em;scroll:auto;"><input style="margin-top:2em;padding:.5em;border:0.1em solid #cccccc;height:2.5em;width:29em;" id="tagline_box" type="text" maxlength="50" style="resize:none;height:30px;" /></div>');
				$('#tagline_container').append('<div style="margin: 1em 0em;"><input style="width:6.5em;height:3em;font-weight:bold;background-color:#336699;color:#ffffff;cursor:pointer;" type="submit" value="Cancel" class="mood_button" onclick="ui.tagline_close(this)" /><input style="margin-left:2em;font-weight:bold;width:12em;height:3em;background-color:#336699;color:#ffffff;cursor:pointer;" type="submit" value="Set My Tagline" id="mood_done" onclick="action.tagline(this)"/></div>');
				$('#tagline_box').focus();
			} 
			...
			$('body').append('<div id="bg_first" style="position:fixed;top:0em;left:0em;width:100%;height:100%;background-color:black;opacity:0.9;z-index:99;filter:alpha(opacity=80);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=80)"; filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=80);"></div>');
			$('body').append('<div id="image_con" style="background-color:#000000;position:fixed;left:0em;top:0em;height:100%;width:100%;z-index:100;display:table;"><div id="container_for_image" style="height:'+maxh+'px;width:'+maxw+'px;display:table-cell;vertical-align:middle;padding:1em 0em 2em 0em;"><img src="thumbnail.php?file='+file+'&maxw='+maxw+'&maxh='+maxh+'"/></div><div style="text-align:left;padding:0em 0em 0em 0em;width:36em;overflow-y:auto;overflow-x:hidden;height:'+maxh+'px;float:right;background-color:#ffffff;margin:1em 1em 2em 0em;"><div data='+actionid+' id="viweable_sidebar" style="width:33.7em;padding:0.5em 2em 0em 0.5em;"><input type="hidden" value="'+profileid+'"/><input type="hidden" value="'+actiontype+'"/></div></div></div>'); 
			
			$.getJSON('ajax/news_json.php',{actionid:actionid,life_is_fun:'life_is_fun'},function(data){
			
				$.each(data.action,function(index,value){
					$('#viweable_sidebar').append('<a href="profile.php?id='+value.actionby+' " ><img style="margin-right:0.7em;" class="lfloat" src ='+data.pimage[value.actionby]+ ' height="50" width="50" /></a><div class="name_50_viewable"><a class="bold" href="profile.php?id=' +value.actionby+' " >' +data.name[value.actionby]+ '</a><div class="time_tag_json"><a href="action.php?actionid='+value.pageid+'&life_is_fun='+value.life_is_fun+'"><img src="png/clock.png" width="6" /><span class="time" data="'+value.time+'">'+time_difference(value.time)+'</span></a></div></div>');
				var myprofileid = $('#myprofileid_hidden').attr('value');
				if(value.actiontype == 50 || value.actiontype == 16 || value.actiontype == 25)
				{
					$('#viweable_sidebar').children().eq(3).append('<div class="likeclass_json" style="margin-top:3em;"><span class="response" style="color:blue;">New-Pinch: </span><span id="viewable_sidebar_response" class="excited_people"></span><span class="post_pointer"></span></div>');	
				}
				else
				{
					$('#viweable_sidebar').children().eq(3).append('<div class="likeclass_json" style="margin-top:3em;"><span class="response" style="color:blue;">Exciting: </span><span id="viewable_sidebar_response" class="excited_people"></span><span class="post_pointer"></span></div>');	
				}	
				var excited_count = 0;
				...
				{
					$('#viweable_sidebar').children().eq(3).append('<div class="comments_show"><input type="hidden" value="'+value.actionid_third+'" /><span class="show_all_comments" >Show all '+ value.comment_count+' comments</span></div>');
				}
				$.each(value.com,function(index,com){
				
					var comid = 'pf_'+value.actionid+'_'+ com.com_actionid;
				
					$('#viweable_sidebar').children().eq(3).append('<div class="cclass_json" id="'+comid+'" data="'+ com.com_actionid +'" ><a href="profile.php?id=' +com.commentby+ '" target="_parent"><img class="lfloat" src =' +data.pimage[com.commentby]+ ' height="32" width="32" /></a><div class="name_35"><div><a class="bold" href="profile.php?id=' +com.commentby+ '" target="_parent">' +data.name[com.commentby]+ '</a> '+ com.comment +'</div><div><a class="comment_time_json" href="action.php?actionid='+value.pageid+'&life_is_fun='+value.life_is_fun+'"><img src="png/clock.png" width="6" /><span class="time" data="'+com.com_time+'">'+time_difference(com.com_time)+'</span></a><span data=' +com.commentby+ ' class = "comment_excite_json">Exciting</span></div></div></div>');
				
					if(com.com_excited)
					{
						$("#"+comid).children().eq(1).children().eq(1).append('<span class="more_excite_json" >'+ com.com_excited +' people excited</span>');
					}
					else 
					{
						$("#"+comid).children().eq(1).children().eq(1).append('<span class="more_excite_json" ></span>');
					}
					
					if(value.postby==myprofileid || com.commentby==myprofileid)
					{
						$('#viweable_sidebar').children().eq(1).append('<span class="del_post comment_setting">x</span>');
					}
				
				});
				
					$('#viweable_sidebar').children().eq(3).append('<div></div><div class="cclass_box" ><a href="profile.php?id=' +myprofileid+ '"><img class="lfloat" src="'+myphoto+'"  width="32" height="32"/></a><input style="margin:0em 0em 0em 0.5em;"class="commentbox" type="text" value="" placeholder="Add a comment..." /></div>');
		...
		{
			window.location="http://www.quipmate.com/?hl=inbox";
		}
