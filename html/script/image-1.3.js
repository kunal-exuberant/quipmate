...
$('.viewable').live('click',function(){
	...
	if($(this).hasClass('video_play')) 
	{
		...
		$('body').append('<div id="image_con" style="background-color:#000000;position:fixed;left:0em;top:0em;height:100%;width:100%;z-index:1000;display:table;"><div id="container_for_image" style="height:'+maxh+'px;width:'+maxw+'px;display:table-cell;vertical-align:middle;padding:1em 0em 2em 0em;"><iframe id="video_playing" width="'+maxw+'" height="'+maxh+'" src="http://www.youtube.com/embed/'+videoid+'?autoplay=1" frameborder="0"></iframe></div><div style="text-align:left;padding:0em 0em 0em 0em;width:36em;overflow-y:auto;overflow-x:hidden;height:'+maxh+'px;float:right;background-color:#ffffff;margin:1em 1em 2em 0em;"><div data='+actionid+' id="viweable_sidebar" style="width:33.7em;padding:0.5em 2em 0em 0.5em;"><input type="hidden" value="'+profileid+'"/><input type="hidden" value="'+actiontype+'"/></div></div></div>'); 
	}  
	else
	{
