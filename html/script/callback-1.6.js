		...
		function user_details(me, data)
			{
				...
				if(data.ack ==1)
				{
					$('#fetch_user_details').html('<div><a href="profile.php?id='+data.profileid+'"><img class="lfloat" src =' +data.pimage+ ' height="80" width="80" /></a><div class="name_80"><a class="bold" href="profile.php?id='+data.profileid+'">'+data.name+'</a></div><input type="submit" onclick='+function_call+' value='+text+' title='+text+' class="callback_user_details" /></div>');
				}
				else
				{
