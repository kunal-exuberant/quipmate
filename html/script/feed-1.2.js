   ...
   var feed = (function(){	
			...
			function event_link_decode(value,name,pimage,container,dom_id)
			{
				...
				if(value.video)
				{ 
					postid.children().eq(1).children().eq(3).append('<div style="position:relative;"><input type="hidden" value="'+value.file+'" /><img class="video_play lfloat" style="margin:0em 1em 1em 0em;cursor:pointer;" src="http://img.youtube.com/vi/'+value.file+'/default.jpg" /><img class="video_play" style="position:absolute;left:4em;top:3em;cursor:pointer;" src="http://icon.qmcdn.net/video_play_icon.png" /><div style="margin:2em 0em 0em 0em;"><div>'+value.title+'</div><a href="'+value.link+'" target="_blank">'+value.host+'</a><div>'+value.meta+'</div><div>'+ui.see_more(ui.get_smiley(ui.link_highlight(value.page)))+'</div></div><br style= "clear:both;"/></div>');
				}
				else
				{
