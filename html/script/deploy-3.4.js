var deploy = (function()
{
   ...
   function action_decode(feed_type, value, name, pimage, container, dom_id, instant, append)
   {
      ...
      case '2926':
         ...
         break;
      case '900':
         action_desc = ' awarded as star of the week ';
         action_object = '';
         break;                  
      case '902':
         action_desc = ' commented on ';
         action_object = 'achievement';
         break;
      case '911':
         action_desc = ' excited on ';
         action_object = 'achievement';
         break;
      default:
      ...
      else if (value.actiontype == 900)
      {
         ...
         {
            $(container).append('<div class="notice_drop"  id="' + con + value.actionid + value.actiontype + '"><input type="hidden" id=' + value.actionid + ' value="' + value.life_is_fun + '"/><img class="lfloat" src =' + pimage[lastactionby] + ' height="50" width="50" /><div class="notice_name">' + action.name_split(name, value.actionby) + action_desc + ' to you</div></div>');
         }
      }      
      ...
      else if (value.actiontype == 602 || value.actiontype == 611 || value.actiontype == 702 || value.actiontype == 711 || value.actiontype == 802 || value.actiontype == 811 || value.actiontype == 1902 || value.actiontype == 1911 || value.actiontype == 2402 || value.actiontype == 2411 || value.actiontype == 2502 || value.actiontype == 2511 || value.actiontype == 2602 || value.actiontype == 2611 || value.actiontype == 2802 || value.actiontype == 2811 || value.actiontype == 902 || value.actiontype == 911)
      {
         if (feed_type == 'news_feed')
         {
            if(value.actiontype == 902 || value.actiontype == 911)
            {
                name_display = name[value.actionon];
            }
            else
            {
                name_display = name[value.postby];
            }
             
            postid.append('<div class="news name_50"><a class="ajax_nav" href="profile.php?id=' + value.actionby + ' " >' + name[value.actionby] + '</a>' + action_desc + ' <a class="ajax_nav" href="profile.php?id=' + value.postby + ' " >' + name_display + '</a>\'s ' + action_object + '</div>');
         }
         else if (feed_type == 'live_feed')
         {
            postid.append('<input type="hidden" value="' + value.pageid + '" /><input type="hidden" value="' + value.life_is_fun + '" /><img class="rtm_each_photo" height="30" width="30" src="' + pimage[value.actionby] + '" /><span class="rtm_each_text"><b>' + name[value.actionby] + '</b> ' + action_desc + ' ' + name[value.actionon] + '\'s ' + action_object + '</span>');
   ...
   function bio_deploy(data)
   {
      ...
      {
         $('#profile_above').append('<div style="font-size:1.1em;color:black;font-weight:bold;">'+data.designation[0].name+'</div>');
      }
      $('#profile_above').append('<div><span class="glyphicon glyphicon-envelope "></span>:<a href=mailto:'+data.email+' >'+data.email+'</a></div>');
      ...
      {
        $('#profile_above').append('<div id="badge_container"></div>');
        var icon_cdn = $('#icon_cdn').attr('value');
        $.each(data.badge,function(index,value){
            var file = icon_cdn+'/'+value.file;
            $('#badge_container').append('<div class="rfloat" title="'+value.name+'"><img src="'+file+'"  width="70" heigth="70"/></div>');
            
        });
      }
      
      $('.bio_row').append('<div id="prev" class="bio_indiv_container"></div>');
...
/********************************************* Increasing center in case of bio **/
...
/********************************************************************************/         
      ...
      if (page == 'home')
      {
         ...
         $('#left').html('<div class="panel panel-default"><div class="panel-body left_option"><ul class=" nav nav-pills nav-stacked"><li ><a class="links ajax_nav" id="news_json" href="?hl=update" title="Updates from your followings"><span >News Feed</span></a></li><li ><a  class="links ajax_nav" id="inbox" href="?hl=inbox" title="Messages from your friends"><span >Messages</span></a></li><li ><a class="links ajax_nav" id="file" href="profile.php?hl=file" title="Central location for all files on your network"><span >Knowledge Base</span></a></li><li ><a class="links ajax_nav" id="new_user" href="?hl=new_user" title="Find out who joined Quipmate after you"><span >Co-workers</span></a></li></ul></div></div><div class="panel panel-default top1" name="group"><div class="panel-heading">Groups</div><div class="panel-body left_option"><ul id="groups_append" class="nav nav-pills nav-stacked"></ul></div></div><div name="event" class="panel panel-default top1"><div class="panel-heading">Events</div><div class="panel-body left_option"><ul id="events_append" class="nav nav-pills nav-stacked"></ul></div></div><div id="friend_event" class="panel panel-default"><div id="friend_event_body" class="panel-body left_option"></div></div><div style="margin-top:1em;padding-top:.5em;border-top:.1em solid #cccccc;"><a href="#" target="_blank"><small>&copy; Quipmate</small></a><span class="separator">|</span><a href="public/help.php" target="_blank"><small>Help</small></a><span class="separator">|</span><a href="#" onclick="ui.feedback(this)"><small>Feedback</small></a></div>');
...
/*Removed code 
      ...
      else if (page == 'admin_json')
      {
         ...
         $('#left').html('<div class="panel panel-default"><div class="panel-body left_option"><ul class=" nav nav-pills nav-stacked"><li class="links"><a class="ajax_nav" id="admin_json" href="admin.php?hl=update" title="Posts shared by everyone on your network"><span >Admin Feed</span></a></li><li class="links"><a class="ajax_nav" id="invite" href="admin.php?hl=invite" title="Invite fellow assciates to the network"><span >Invite Employees</span></a></li><li class="links"><a class="ajax_nav" id="admin_list" href="admin.php?hl=admin" title="List of all admins of this network"><span >Admin List</span></a></li><li class="links"><a class="ajax_nav" id="usefullinks" href="admin.php?hl=usefullinks" title="Post Useful Links"><span >Useful Links</span></a></li><li class="links"><a class="ajax_nav" id="designation" href="admin.php?hl=designation" title="designation"><span >Designation</span></a></li> <li class="links"><a class="ajax_nav" id="team" href="admin.php?hl=team" title="team"><span >Team</span></a></li> <li class="links"><a class="ajax_nav" id="sotw" href="admin.php?hl=sotw" title="Star Of The Week"><span >Star Of The Week</span></a></li><li class="links"><a class="ajax_nav" id="group_byadmin" href="admin.php?hl=group_byadmin" title="Groups To Suggest"><span >Groups To Suggest</span></a></li><li class="links"><a class="ajax_nav" id="remove_user" href="admin.php?hl=remove_user" title="Disable a user account"><span >Disable User Account</span></a></li><li class="links"><a class="ajax_nav" href="admin.php?hl=analytics" title="Analytics"><span >Analytics</span></a></li><li class="links"><a class="ajax_nav" id="feature" href="admin.php?hl=feature" title="Feature setting"><span >Control features</span></a></li></ul></div></div><div class="panel panel-default"><div class="panel-heading">Pages</div><div class="panel-body left_option"><ul id="page" class="nav nav-pills nav-stacked"></ul></div></div><div style="margin-top:1em;padding-top:.5em;border-top:.1em solid #cccccc;"><a href="#" target="_blank"><small>&copy; Quipmate</small></a><span class="separator">|</span><a href="public/help.php" target="_blank"><small>Help</small></a><span class="separator">|</span><a href="public/terms.php" target="_blank"><small>Terms of Use</small></a></div>');
      //Removed code  <li class="links"><a class="ajax_nav" id="flashboard" href="admin.php?hl=flashboard" title="Flashboard"><span >Flashboard</span></a></li>
         $('#right').html('');
         ...
         window.ajax_queue.push($.getJSON(url, param, function(data)
         {
            ...
            $('#page').append('<li ><a href="#" onclick="ui.page_create(this)" title="Create a page to broadcast news to all the employees"><span >Create Page</span></a></li>')
         }));
      ...
      else if (page == 'usefullinks')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Post Useful Links</div><div class="panel-body"><div style="margin:3em;border:0.1em solid #aaaaaa;width:34.6em;height:20.2em;padding:0.5em;margin-right:0.2em; overflow-y:scroll; overflow-x:hidden;" id="usefullinks_box"></div><textarea id="link_box" placeholder="Paste/type a link here ?"/></textarea><input id="ullink_button" type="submit" class="theme_button" value="Share"></div></div></div>');
      ...
      else if (page == 'team')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Teams</div><div class="panel-body"><div style="margin:3em;border:0.1em solid #aaaaaa;width:34.6em;height:20.2em;padding:0.5em;margin-right:0.2em; overflow-y:scroll; overflow-x:hidden;" id="team_show_box"></div><input type="text" class="form-control" placeholder="Add a team" style="margin-left:2.80em;width:50%;display:inline" id="team_box"/> 	<input type="submit" onclick="action.team(this)" value="Add" id="team_button" title="Add" /></div></div>');
         action.team_fetch();
      }
      else if (page == 'sotw')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Star Of The Week</div><div class="panel-body"><input type="text" id="hso" autocomplete="off" style="width:20em; margin-left:20px; margin-top:20px;" class="form-control" placeholder="Who is the star of the week"> <div id="star_container" width="200px" style="margin-left:20px;" ></div><div id="sotw2" style="width:30em; margin-left:20px;"></div></div></div>');
         action.sotw_load();
      }
      else if (page == 'group_byadmin')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Groups To Suggest</div><div class="panel-body"></div></div>');
         action.groups_fetch();
      }
      else if (page == 'flashboard')
      {
      ...
      else if (page == 'designation')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Designations</div><div class="panel-body"><div style="margin:3em;border:0.1em solid #aaaaaa;width:34.6em;height:20.2em;padding:0.5em;margin-right:0.2em; overflow-y:scroll; overflow-x:hidden;" id="designation_show_box"></div><input type="text" class="form-control" placeholder="Add a designation" style="margin-left:2.80em;width:50%;display:inline" id="designation_box"/> 	<input type="submit" onclick="action.designation(this)" value="Add" id="designation_button" class="theme_button" title="Add" /></div></div></div>');
 ...
 //<h1 class="page_title">Managing Director</h1><input type="text" id="mdadd" autocomplete="off" style="width:20em; margin-left:2.80em; margin-top:20px;" class="form-control" placeholder="Who is the managing director"> <div id="md_container" width="200px" style="margin-left:20px;" ></div><div id="md_co" style="width:30em; margin-left:20px;"><input type="submit" class="theme_button" style="margin-top:-34px;" onclick="action.addmd(this)" value="Add MD" id="add_md_button" title="Add MD" />        
      ...
      else if (page == 'admin_list')
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Manage Admins</div><div class="panel-body"><div style="padding:4em;"><input id="remove_user_email" type="text" placeholder="Enter the email address" value="" style="padding:0.5em;width: 22em;" /><input id="invite_button" class="theme_button" type="submit" onclick="action.user_details(this)" value="Add Admin" data="Add Admin" title="Add as admin" style="width: 7.6em;" /></div><div id="fetch_user_details" style="padding:1.5em;"></div></div></div><div class="panel panel-default"><div class="panel-heading">Existing Admins</div><div class="panel-body" id="existing_admin_body"></div></div>');
         url = 'ajax/write.php';
      ...
      else if (page == 'remove_user') 
      {
         ...
         $(document).attr('title', 'Quipmate - Admin Interface');
         //url = 'ajax/write.php';
         $('#center').html('<div class="panel panel-default"><div class="panel-heading">Disable the account of an user </div><div class="panel-body"><div style="padding:5em;"><input id="remove_user_email" type="text" placeholder="Enter the email address" value="" style="padding:0.5em;width: 22em;" /><input class="theme_button" type="submit" onclick="action.user_details(this)" value="Disable User" data="Disable User" title="Disable User" /></div><div id="fetch_user_details" style="padding:1.5em;"></div></div></div>');
      }
      ...
      else if (page == 'group_json')
      {
         ...
         window.ajax_queue.push($.getJSON(url, param, function(data)
         {
            ...
            $('#left').html('<div class="panel"><div id="group_parent_left"><div class="text-center"><a class="ajax_nav" href="group.php?id=' + data.info.groupid + '"><img src="' + data.info.group_photo + '" /></a></div><div class="text-center"><a  class="ajax_nav" href="group.php?id=' + data.info.groupid + '" class="ellipsis">' + data.info.groupname + '</a></div></div><ul class=" nav nav-pills nav-stacked panel-body"> <li class="links"><a class="ajax_nav" id="group_json" href="group.php?id=' + data.info.groupid + '" title="Your activities"><span >Group Feed</span></a></li><li class="links"><a class="ajax_nav" href="group.php?id=' + data.info.groupid + '&hl=about" title="Your Bio"><span >About</span></a></li><li class="links"><a class="ajax_nav" href="group.php?id=' + data.info.groupid + '&hl=member" title="Group Members"><span >Members(' + data.info.member_count + ')</span></a></li></ul></div>');
            if (data.info.priviledge == 0)
            {
               $('#group_parent_left').append('<div style="margin-top:0.5em;text-align:center;"><a style="color:#003399;" class="ajax_nav" href="group.php?id=' + data.info.groupid + '&hl=settings">Edit Group Settings</a></div>');
            }
            ...
            if (data.info.priviledge == 2 || data.info.priviledge == 3)
            {
               ...
               $('#center').html('<div class="panel panel-default"><div class="panel-heading">About this group</div><div class="panel-body"><h4 class="bold">' + data.info.groupname + '</h4><div ><h6>' + data.info.description + '</h6></div><div><a  class="ajax_nav" style="font-size:1em;" href="profile.php?id=' + data.info.createdby + '"><h6>' + data.name[data.info.createdby] + '</a> created this group</h6></div></div>');
            }
            else
            {
               page = 'group_json';
      ...
      else if (page == 'group_settings')
      {
         ...
         {
            $(document).attr('title', data.info.groupname);
            $('#center').html('<div class="panel panel-default"><div class="panel-heading">Group Settings</div><div class="panel-body" id="group_setting_body"><div id="group_info"></div><div><h4 class="bold text-center">'+ data.info.groupname + '</h4></div><div class="form-group"><textarea id="group_description" class="form-control">' + data.info.description + '</textarea></div><div class="form-group"><label>Privacy:</label><select id="group_privacy" class="form-control"><option value="0">Public</option><option value="1">Private</option></select></div><div class="form-group"><textarea class="form-control" id="group_link" placeholder="Relevant links">' + data.info.link + '</textarea></div></div></div>');
            if (data.info.technical == 1)
            {
               $('#group_setting_body').append('<div class="form-group">This group is for technical discussions</div><div class="form-group"><textarea class="form-control" id="group_link" placeholder="Relevant links">' + data.info.link + '</textarea></div>');
            }
            if (data.info.invite == 1)
            {
               $('#group_setting_body').append('<div class="form-group"><label><input type="checkbox" id="group_invite" checked> Only group admin can add or approve membership requests</label></div>');
            }
            else
            {
               $('#group_setting_body').append('<div class="form-group"><label><input type="checkbox" id="group_invite"> Only group admin can add or approve membership requests</label></div>');
            }
            $('#group_setting_body').append('<div class="form-group"><button onclick="action.group_settings_save(this)" class="btn btn-primary bold">Save</button></div>');
           /*
             <h1 class="page_title">Attach Document</h1><form id="flashform" method="post" enctype="multipart/form-data" action="/ajax/write.php"><textarea style="border:1px solid #cccccc;height:2.7em;padding:0.5em;margin:0.5em;width:34.6em;margin-left:3em;" type="text" placeholder="Say something about this file" maxlength="200" id="photo_description" name="doc_description"></textarea><div id="vish_Btn" style="position: relative;top: 10px;font-family: calibri;width: 180px;height:100px;padding-top:35px;-webkit-border-radius: 5px;-moz-border-radius: 5px;border: 1px dashed #BBB; text-align: center;background-color:#DDD;cursor:pointer; margin-left:18em;">Upload Document</div><input type="file" id="html_btn" size="40" style="margin-top:-20px; margin-left:95px; display:none;" name="doc"/></br><input type="submit" name="upload" class="imgshow"  id="flash_upload_button" value="Upload" style="margin-left:18em;"><img src="https://372a66a66bee4b5f4c15-ab04d5978fd374d95bde5ab402b5a60b.ssl.cf2.rackcdn.com/upload.gif" class="imghide"  
            id="uploading"/><input type="hidden" name="action" value="group_pinned_doc_upload"><input type="hidden" name="doc_hidden_profileid" value="' + profileid + '"></form>');
            */
         }));
         var groupid = profileid;
      ...
      else if (page == 'event_json')
      {
         ...
         window.ajax_queue.push($.getJSON(url, param, function(data)
         {
            ...
            if (data.info.priviledge == 0)
            {
               $('#event_left_parent').append('<div style="margin-top:0.5em;text-align:center;"><a style="color:#003399;" class="ajax_nav" href="event.php?id=' + data.info.eventid + '&hl=settings">Edit Event Settings</a>');
            }
            $('#right').html('');
            ...
            else
            {
               ...
               $(document).attr('title', data.info.eventname);
               $('#center').html('<div class="panel panel-default"><div class=""panel-heading>About this Event</div><div class="panel-body"><div><h4 class="bold">' + data.info.eventname + '</h4></div><div ><h5>' + data.info.description + '</h5></div><div><h5>On ' + data.info.date + ' at ' + data.info.time + '</h5></div><div ><h5>At ' + data.info.venue + '</h5></div><div ><h5>' + data.info.guest_count + ' guests</h5></div><div ><h5><a class="ajax_nav" href="profile.php?id=' + data.host + '"> ' + data.name[data.host] + '</a> is the host</h5></div></div></div>');
            }
         }));
         myprofileid = $('#myprofileid_hidden').attr('value');
         myphoto = $('#myprofileimage_hidden').attr('value');
      ...
      else if (page == 'event_setting')
      {
         ...
         {
            $(document).attr('title', data.info.eventname);
$('#center').html('<div class="panel panel-default"><div class="panel-heading">Event Settings</div><div class="panel-body" id="event_setting_body"><div id="group_info"></div><div><h4>' + data.info.eventname + '</h4></div><div class="form-group"><textarea id="group_description" class="form-control">' + data.info.description + '</textarea></div><div class="form-group"><label>Privacy:</label><select id="group_privacy" class="form-control"><option value="0">Public</option><option value="1">Private</option></select></div><div class="form-group"><label>When :</label><div class="form-inline"><select id="event_day" class="form-control" ><option value="-1">Day</option></select><select id="event_month" class="form-control" ><option value="-1">Month</option> <option value="01">JAN</option><option value="02">FEB</option><option value="03">MAR</option><option value="04">APR</option><option value="05">MAY</option><option value="06">JUN</option> <option value="07">JUL</option><option value="08">AUG</option> <option value="09">SEP</option><option value="10">OCT</option><option value="11">NOV</option> <option value="12">DEC</option></select><select id="event_year" class="form-control" ><option value="-1">Year</option></select><select id="event_time"  class="form-control"><option value="-1">Time</option></select></div></div><div class="form-group"><label>Where:</label><input type="text" id="event_where" value="' + data.info.venue + '" class="form-control"/></div></div></div>');    
              
            for(i=1;i<=31;i++)
            {
                $('#event_day').append('<option value="'+i+'">'+i+'</option>');
            }
             for(h=0;h<=23;h++){  
                for(m=0;m<=1;m=m+30)
                    {  $('#event_time').append('<option value='+h+':'+m+'>'+h+':'+m+'</option>'); 
                    };
            };
            ...
            if (data.info.invite == 1)
            {
               $('#event_setting_body').append('<div class="form-group"><label><input type="checkbox" id="group_invite" checked> Guests can invite their followers</label></div>');
            }
            else
            {
               $('#event_setting_body').append('<div class="form-group"><label><input type="checkbox" id="group_invite"> Guests can invite their followers</label></div>');
            }
            $('#event_setting_body').append('<div class="form-group"><button onclick="action.event_settings_save(this)" class="btn btn-primary bold">Save</button></div>');
         }));
         param.eventid = $('#profileid_hidden').attr('value');
         myprofileid = $('#myprofileid_hidden').attr('value');
         myphoto = $('#myprofileimage_hidden').attr('value');
      ...
      /*   $('.row').html('');
         ...
         window.ajax_queue.push($.getJSON(url, param, function(data)
         {
            ...
            $('#profilename_hidden').attr('value', data.info.name);
            $('#left').html('<div class="panel panel-default"><div class="panel-body left_option"><ul class=" nav nav-pills nav-stacked"><li class="links"><a class="ajax_nav" id="profile_json" href="profile.php?id=' + profileid + '&hl=diary" title="Your activities"><span >Diary</span></a></li><li class="links"><a class="ajax_nav" id="bio" href="profile.php?id=' + profileid + '&hl=bio" title="Your Bio"><span >Bio</span></a></li><li class="links"><a class="ajax_nav" id="praise" href="profile.php?id=' + profileid + '&hl=praise" title="Your Praises"><span >Praises</span></a></li><li class="links"><a class="ajax_nav" id="pphoto" href="profile.php?id=' + profileid + '&hl=image" title="Your Photos"><span >Photos</span></a></li><li class="links"><a  class="ajax_nav" id="following" href="profile.php?id=' + profileid + '&hl=following" title="You are following"><span >Following (' + data.info.following_count + ')</span></a></li><li class="links"><a  class="ajax_nav" id="followers" href="profile.php?id=' + profileid + '&hl=followers" title="Your followers"><span >Followers (' + data.info.followers_count + ')</span></a></li></ul></div></div>');
...
//removed from left 
      ...
      else if (page == 'profile_json')
      {
         ...
         param.profileid = $('#profileid_hidden').attr('value');
         window.increment = 10;
         $('#prev').html('<div id="news_poll"></div>');
         $('#upload_box').remove();
         $('#prev').prepend('<div id="sharing_area"></div>');
         $(document).attr('title', profile_name + ' - Profile');
...
//         $('html').css('overflow', 'hidden')
      ...
      else if (page == 'praise')
      {
         ...
         var profile_name = $('#profilename_hidden').attr('value');
         $('#prev').html('');
         $('#prev').append('<h1 class="page_title">' + profile_name + ' - Praises/Recommendations</h1>');
         $('#center').append('<input type="submit" id="load_more" style="height:30px;width:150px;margin-left:200px;display:none;" value="Show More Praises" />');
...
/*var pos = state.url.indexOf('id=');
         ...
         $('#center').html('<div id="bio_display"></div><div id="prev"></div>');
      }
      if (page != 'inbox')
      {
         action.first_loader(page, param);
