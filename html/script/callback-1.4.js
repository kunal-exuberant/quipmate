	...
	var callback = (function(){
		...
		function user_details(me, data)
		{
			if(data.ack ==1)
			{
				$('#invite_button').attr('value','Remove User');
				$('#fetch_user_details').html('<div><a href="profile.php?id='+data.profileid+'"><img class="lfloat" src =' +data.pimage+ ' height="80" width="80" /></a><div class="name_80"><a class="bold" href="profile.php?id='+data.profileid+'">'+data.name+'</a></div><input type="submit" onclick="action.user_delete(this,'+data.profileid+')" value="Remove User" title="Remove User" style=" background: none repeat scroll 0 0 #336699;color:#FFFFFF;cursor:pointer;font-weight:bold;height: 3.4em; padding: 0.2em;width: 10.6em;" /></div>');
			}
			else
			{
				$('#invite_button').attr('value','Remove User');
		...
		{
			$('#friend_match').html('<div class="subtitle">Top Influencers of this group('+data.count+')</div>');
			var i = 0;
			$.each(data.match,function(index,value){
				if(i==0)
				{
					$('#friend_match').append('<span class="friend_match_class" style="margin:0.1em;"><a href="profile.php?id='+value.profileid+'"><img src="'+data.pimage[value.profileid]+'" height="50" width="50" title="'+data.name[value.profileid]+'"></a></span>');
				}
				else
				{
					$('#friend_match').append('<span class="friend_match_class" style="margin:0.1em;"><a href="profile.php?id='+value.profileid+'"><img src="'+data.pimage[value.profileid]+'" height="40" width="40" title="'+data.name[value.profileid]+'"></a></span>');
				}	
				i++;
			});
		}
		...
		function gift_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$('#gift_recent').append('<div class="container_32_35 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')" id="gift_'+value.actionby+'"><a style="color:#336699;" href="profile.php?id='+value.actionby+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionby]+'" height="35" width="32" /></a><div class="name_32_35"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionby+'&pl=diary">'+data.name[value.actionby]+'</a> To <a style="color:#336699;" href="profile.php?id='+value.actionon+'&pl=diary">'+data.name[value.actionon]+'</a>: '+value.gift+'<div>'+value.page+'</div></div></div>');
				});
			} 
			else
			{
		...
		function missu_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$('#missu_recent').append('<div class="container_32 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')" id="missu_'+value.actionon+'"><a style="color:#336699;" href="profile.php?id='+value.actionon+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionon]+'" height="32" width="32" /></a><div class="name_32"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionon+'&pl=diary">'+data.name[value.actionon]+'</a></div></div>');
				});
			} 
			else
			{
		...
		function mood_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$('#mood_recent').append('<div class="container_32_35 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')" id="mood_'+value.actionby+'"><a style="color:#336699;" href="profile.php?id='+value.actionby+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionby]+'" height="35" width="32" /></a><div class="name_32_35"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionby+'&pl=diary">'+data.name[value.actionby]+'</a> is '+value.mood+'<div>'+value.page+'</div></div></div>');
				});
			} 
			else
			{
		...
		function show_all_comments(me, data)
		{
			...
			$.each(data.com,function(index,com){  
				...
				if(com.postby==myprofileid || com.remove == 1)
				{
		...
		function song_dedicate_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$('#dedicate_song').append('<div class="container_32_35 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')" ><a style="color:#336699;" href="profile.php?id='+value.actionon+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionon]+'" height="35" width="32" /></a><div class="name_32"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionon+'&pl=diary">'+data.name[value.actionon]+'</a> from <a style="color:#336699;" href="profile.php?id='+value.actionby+'&pl=diary">'+data.name[value.actionby]+'</a><div style="color:#000000;">'+value.song+'</div></div></div>');
				});
			} 
			else
			{
		...
		function status_song_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$.each(data.action,function(index,value){ 
				var file = 'http://song.qmcdn.net/'+value.file;
				$('#status_song').append('<div class="container_32_35 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')"><a style="color:#336699;" href="profile.php?id='+value.actionby+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionby]+'" height="35" width="32" /></a><div class="name_32_35"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionby+'&pl=diary">'+data.name[value.actionby]+'</a><div style="color:#000000;">'+value.song+'</div></div></div>');
				});
			} 
			else
			{
		...
		function search(me, data)
		{
			if(data.count >= 0)
			{
				...
				{
					$('#search_result').append('<div class="people_each"><a href="profile.php?id='+value.profileid+'"><img class="lfloat" src="'+data.pimage[value.profileid]+'" height="80" width="80" /></a><div class="name_80"><a class="bold" href="profile.php?id='+value.profileid+'">'+data.name[value.profileid]+'</a><div>'+ui.see_more(value.page)+'</div></div></div>');
				}
				else
				{
					$('#search_result').append('<div class="people_each"><a href="profile.php?id='+value.profileid+'"><img class="lfloat" src="'+data.pimage[value.profileid]+'" height="80" width="80" /></a><div class="name_80"><a class="bold" href="profile.php?id='+value.profileid+'">'+data.name[value.profileid]+'</a><div style="margin-top:1em;">'+data.filter+' matched: <b>'+value.page+'</b></div></div></div>');
				}
				});
			}
			else
		...
		function tagline_preview(me, data)
		{
			if(data.action.length > 0)
			{
				...
				$('#tagline_recent').append('<div class="container_32_35 pointer" onclick="ui.redirect_to_action('+value.actionid+',\''+value.life_is_fun+'\')" id="tagline_'+value.actionby+'"><a style="color:#336699;" href="profile.php?id='+value.actionby+'&pl=diary"><img class="lfloat" src="'+data.pimage[value.actionby]+'" height="35" width="32" /></a><div class="name_32"><a style="color:#336699;font-weight:bold;" href="profile.php?id='+value.actionby+'&pl=diary">'+data.name[value.actionby]+'</a><div>'+value.tagline+'</div></div></div>'); 
				});
			} 
			else
			{
